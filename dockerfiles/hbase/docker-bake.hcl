...
variable IMAGE_NAME {
  default = "${USER}/hbase/kustomize/hbase"
}

group default {
  targets = [ "hbase", "hbase-test" ]
}

target hbase {
  dockerfile = "dockerfiles/hbase/Dockerfile"
  args = {
    HBASE_TGZ_URL = HBASE_TGZ_URL
    HBASE_TGZ = HBASE_TGZ
    HBASE_TGZ_SHA512_URL = HBASE_TGZ_SHA512_URL
    HBASE_TGZ_SHA512 = HBASE_TGZ_SHA512
    HBASE_OPERATOR_TOOLS_TGZ_URL = HBASE_OPERATOR_TOOLS_TGZ_URL
    HBASE_OPERATOR_TOOLS_TGZ = HBASE_OPERATOR_TOOLS_TGZ
    HBASE_OPERATOR_TOOLS_TGZ_SHA512 = HBASE_OPERATOR_TOOLS_TGZ_SHA512
    HBASE_OPERATOR_TOOLS_TGZ_SHA512_URL = HBASE_OPERATOR_TOOLS_TGZ_SHA512_URL
